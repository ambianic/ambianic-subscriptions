...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmbianicCloudApiCollection.InlineResponse2003Product();
  });
  ...
  describe('InlineResponse2003Product', function() {
    it('should create an instance of InlineResponse2003Product', function() {
      // uncomment below and update the code to test InlineResponse2003Product
      //var instane = new AmbianicCloudApiCollection.InlineResponse2003Product();
      //expect(instance).to.be.a(AmbianicCloudApiCollection.InlineResponse2003Product);
    });

    it('should have the property active (base name: "active")', function() {
      // uncomment below and update the code to test the property active
      //var instance = new AmbianicCloudApiCollection.InlineResponse2003Product();
