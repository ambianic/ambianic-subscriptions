...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmbianicCloudApiCollection.InlineObject1();
  });
  ...
  describe('InlineObject1', function() {
    it('should create an instance of InlineObject1', function() {
      ...
      //var instane = new AmbianicCloudApiCollection.InlineObject1();
      //expect(instance).to.be.a(AmbianicCloudApiCollection.InlineObject1);
    });

    it('should have the property message (base name: "message")', function() {
      // uncomment below and update the code to test the property message
      //var instance = new AmbianicCloudApiCollection.InlineObject1();
