...
class ApiClient {
    constructor() {
         ...
         * @type {String}
         * @default https://ambianic-functions.netlify.app
         */
        this.basePath = 'https://ambianic-functions.netlify.app'.replace(/\/+$/, '');
  ...
  /**
    ...
    */
    hostSettings() {
        return [
            {
              'url': "https://ambianic-functions.netlify.app",
              'description': "No description provided",
            },
            {
              'url': "https://14fecb7f-38f9-43ce-ae90-9381932906cf.mock.pstmn.io",
              'description': "No description provided",
            }
      ];
    }
